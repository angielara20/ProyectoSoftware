...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 19-02-2021 a las 23:02:02
...
CREATE TABLE `usuario` (
  ...
  `sexo_us` varchar(50) DEFAULT NULL,
  `adicional_us` varchar(50) DEFAULT NULL,
...
(1, 'angie', 'lara', '22', 'asd', '123', 784993, 'santamonica', '@dhd', 'F', 'jsjssjs', 1),
(2, 'diego', 'tama', '27', '12', '12', 784993, 'santamoni', '@dhd', 'F', 'jsjssjsid', 2);
